...
<html class="no-js" lang="">
    <head>
        ...
        <title>Shopping Cart | Sozo</title>
    ...
    <section class="cart-area-wrapper">
        <div class="container-fluid">
            <div class="row cart-top">
                <div class="col-md-12">
                    <h1 class="sin-page-title">Shopping Cart</h1>
                            ...
                            <tbody>
                                <tr>
                                    <td class="cart-td-img">
                                     <a href="#">
                                     <img  title="blandit blandit" alt="" src="img/cart-1.jpg"></a>
                                    </td>
                                    <td><a href="#">Auctor gravida enim</a></td>
                                    <td>$ 10</td>
                                    <td>
                                        <span class="plus-minus-cart"> <input type="number" value="0" > </span>
                                    </td>
                                    <td class="cart-total-price">$80.00</td>
                                    <td class="cross"><a ><i class="fa fa-times-circle"></i></a></td>
                                </tr>
                            </tbody>
                            <tbody>
                                <tr>
                                    <td class="cart-td-img">
                                     <a href="#">
                                     <img  title="blandit blandit" alt="" src="img/cart-drop.jpg"></a>
                                    </td>
                                    <td><a href="#">Fermentum eros</a></td>
                                    <td>$ 25</td>
                                    <td>
                                        <span class="plus-minus-cart"> <input type="number" value="0" > </span>
                                    </td>
            ...
            <div class="row cart--bottom">
                ...
                <div class="col-md-4">
                    <div class="cart-carousel-area">
                        <h3>cross-sell</h3>
                        <div class="cart-carousel-start">
                            <!--single product-->
                            <div class="col-md-3 width-hun">
                                <div class="single-product">
                                    ...
                                    <div class="product-image">
                                        ...
                                        <div class="hide-img">
                                            <a href="#"><img src="img/products/prod-6b.jpg" alt=""></a>    
                                        </div>
                                    </div>
                                    <div class="prod-info">
                                        <h2 class="pro-name">
                                        ...
                                        <div class="actions">
                                            ...
                                            <span class="new-pro-compaire">
                                                <a href="#" data-toggle="tooltip" title="Compare"><i class="fa fa-bar-chart"></i></a>
                                            </span>
                                        </div>
                                    </div>
                                </div>    
                            ...
                            <div class="col-md-3 width-hun">
                                <div class="single-product">
                                    ...
                                    <div class="product-image">
                                        ...
                                        <div class="hide-img">
                                            <a href="#"><img src="img/products/prod-11b.jpg" alt=""></a>    
                                        </div>
                                    </div>
                                    <div class="prod-info">
                                        <h2 class="pro-name">
                        ...
                        <h3 class="pull-right">cart-totals</h3>
                         <table style="width:100%">
                              ...
                              <tr class="cart-shipping">
                                <td>shipping</td>
                                <td><span>flat rate</span></td>
                                <td><span class="ship-amount">$5</span></td>
                              </tr>
                              <tr>
                                <td></td>
                                <td><a href="#">Calculate Shipping</a></td>
                                <td></td>
                              </tr>
                              <tr class="order-total">
                                <td>total</td>
                                <td></td>
                                <td class="cart-total">$904</td>
                              </tr>
                        </table>
