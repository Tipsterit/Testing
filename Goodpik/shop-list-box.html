                ...
                <div class="row">
                    ...
                    <div class="col-md-9 col-lg-10">
                        <div class="shop-area">
                            <div class="shop-short-wrapper">
                                <div class="shop-sort">
                                    <ul class="grid-list-button">
                                        ...
                                        <li class="active"><a data-toggle="tab" href="#list"><i class="fa fa-th-list"></i></a></li>
                                    </ul>
                                </div>
                                <p class="ordered-result">Showing 1&ndash;16 of 35 results</p>
                                <div class="orderby-wrapper">
                                    ...
                                    <select class="orderby" name="orderby">
                                        ...
                                        <option selected="selected" value="price-desc">Sort by price: high to low</option>
                                    </select>
                                </div>
                            </div>
                                                ...
                                                <div class="col-sm-4 col-md-4 col-lg-3">
                                                    <div class="single-product">
                                                        ...
                                                        <div class="product-image">
                                                            ...
                                                            <div class="hide-img">
                                                                <a href="#"><img src="img/products/prod-2b.jpg" alt=""></a>    
                                                            </div>
                                                        </div>
                                                        <div class="prod-info">
                                                            <h2 class="pro-name">
                                                            ...
                                                            <div class="prod-list-detail">
                                                                <div class="prod-info">
                                                                    ...
                                                                    <div class="actions">
                                                                        ...
                                                                        <span>
                                                                            <a href="#" title="Quick View" data-target="#productModal" data-toggle="modal"><i class="fa fa-external-link"></i></a>
                                                                        </span>
                                                                    </div>
                                                                </div>   
                                                            </div>
                            ...
                            <div class="pagination-shop pull-right">
