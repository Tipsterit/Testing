...
<html class="no-js" lang="">
    <head>
        ...
        <title>Portfolio Box | Sozo</title>
    ...
    <body class="home-1 portfolio-page">
        <!--[if lt IE 8]>
                ...
                <div class="row">
                    ...
                    <div class="col-md-offset-2 col-md-8">
                        <div class="mixitup-menu">
                            <ul class="mixitup-filter">
                                <li class="filter" data-filter="all">all</li>
                                <li class="filter" data-filter=".mix-one">Fashion</li>
                                <li class="filter" data-filter=".mix-two">Web design</li>
                                <li class="filter" data-filter=".mix-three">photography</li>
                                <li class="filter" data-filter=".mix-four">sun city</li>
                                <li class="filter" data-filter=".mix-five">art glass</li>
                            </ul>
                        </div>
                        <!--mixit-up content start-->
                        <div class="mixitup-content">
                            <div class="mix mix-image mix-one mix-two col-xs-6 col-sm-4 col-md-4 col-lg-4">
                                <a href="#">
                                    <img src="img/portfolio/portfolio-01.jpg" alt="">
                                    <span class="mix-project-info">
                                        <span class="project-date">January 28, 2015</span>
                                        <span class="project-title">Augue lorem lacinia</span>
                                    </span>
                                </a>
                            </div>
                            <div class="mix mix-image mix-one mix-three col-xs-6 col-sm-4 col-md-4 col-lg-4">
                                <a href="#">
                            ...
                            <div class="mix mix-image mix-two mix-four col-xs-6 col-sm-4 col-md-4 col-lg-4">
                                <a href="#">
                            ...
                            <div class="mix mix-image mix-three mix-five col-xs-6 col-sm-4 col-md-4 col-lg-4">
                                <a href="#">
                            ...
                            <div class="mix mix-image mix-four mix-two col-xs-6 col-sm-4 col-md-4 col-lg-4">
                                <a href="#">
                            ...
                            <div class="mix mix-image mix-five mix-three col-xs-6 col-sm-4 col-md-4 col-lg-4">
                                <a href="#">
                            ...
                            <div class="mix mix-image mix-one mix-four col-xs-6 col-sm-4 col-md-4 col-lg-4">
                                <a href="#">
                            ...
                            <div class="mix mix-image mix-one mix-five col-xs-6 col-sm-4 col-md-4">
                                <a href="#">
                            ...
                            <div class="mix mix-image mix-one mix-five col-xs-6 col-sm-4 col-md-4 col-lg-4">
                                <a href="#">
