...
<html class="no-js" lang="">
    <head>
        ...
        <title>Post WithGallery | Sozo</title>
    ...
    <body class="home-1 blog sin-post">
        <!--[if lt IE 8]>
    ...
    <section class="blog-area-wrapper">
        <div class="container-fluid">
            <div class="row">
                <h1 class="sin-page-title">blog</h1>
                <div class="single-post single-blog">
                    <div class="col-md-5">
                        <div class="sin-blog-carousel">
                            <div class="col-md-12 no-padding "> <img src="img/blog-car-2.jpg" alt=""></div>
                            <div class="col-md-12 no-padding"> <img src="img/blog-car-1.jpg" alt=""></div>
                            <div class="col-md-12  no-padding"> <img src="img/blog-car-3.jpg" alt=""></div>
                            <div class="col-md-12 no-padding"> <img src="img/blog-car-4.jpg" alt=""></div>
                        </div>
                    </div>
                    <div class="col-md-7 ">
                        <div class="sin-post-info">
                            <h1 class="blog-title">Post with gallery</h1>
                            <div class="blog-meta-small">
                                <div class="blog-post-date">
                                    <span class="day">10</span><span class="month">Mar</span>				
                                </div>
        Posted by <span class="author"><a href="#">admin</a></span> / <a href="#">Fashion</a>, <a href="#">WordPress</a>			
                            </div>
                            <div class="blog-summary">
                                <p>Donec vitae hendrerit arcu, sit amet faucibus nisl. Cras pretium arcu ex. Aenean posuere libero eu augue                                              condimentum rhoncus. Praesent ornare tortor ac ante egestas hendrerit. Aliquam et metus pharetra, bibendum                                            massa nec, fermentum odio. Nunc id leo ultrices, mollis ligula in, finibus tortor. Mauris eu dui ut lectus                                            fermentum eleifend. Pellentesque faucibus sem ante, non malesuada odio varius nec. Suspendisse potenti.                                                 Proin consectetur aliquam odio nec fringilla. Sed interdum at justo in efficitur. Vivamus gravida volutpat                                             sodales. Fusce ornare
                                </p>
                            ...
                            <div class="blog-meta-small">
                                <a href="#">3 Comments</a>/ Tags : <span class="author"><a href="#">fashion</a>, </span><a href="#">t-shirt</a>, <a href="#">white</a>			                        
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8  col-lg-8">
                                        <div class="protfolio-social">
                                            ...
                                            <li><a data-original-title="Facebook" data-toggle="tooltip" data-placement="top" title="" href="#" class="fb"><i class="fa fa-facebook"></i></a></li>
                                            <li><a data-original-title="Twitter" data-toggle="tooltip" title="" href="#" class="twt"><i class="fa fa-twitter"></i></a></li>
                                            <li><a data-original-title="Pinterest" data-toggle="tooltip" title="" href="#" class="pin"><i class="fa fa-pinterest"></i></a></li>
                                            <li><a data-original-title="Google-plus" data-toggle="tooltip" title="" href="#" class="gle"><i class="fa fa-google-plus"></i></a></li>               <li><a data-original-title="Linked in" data-toggle="tooltip" title="" href="#" class="lin"><i class="fa fa-linkedin"></i>
                    </a></li>
                                            </ul>
                                        </div>
                                    </div>
					...
					<div class="author-avatar">
						<img class="avatar" src="img/user-2.jpg" alt=""></div>
					<div class="author-description">
						<h2>About the Author: <a rel="author" href="#">admin</a></h2>
											...
											<ol class="commentlists">
													...
													<div class="the-comment">
														...
														<div class="comment-box">
															<div class="comment-author meta">
																<p class="com-name"><strong>Salim Rana</strong></p>
																   6 months ago <a href="#" class="comment-reply-link"> Reply </a>				
															</div>
													...
													<ul class="children-comment">
														<li class="comment odd alt depth-2">
															<div class="the-comment">
																...
																<div class="comment-box">
																	<div class="comment-author meta">
																		<p class="com-name"><strong>Nirob</strong></p>
																		 9 months ago<a href="#" class="comment-reply-link"> Reply </a>
																	</div>
																	<div class="comment-text">
																		<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec sed sollicitudin lectus. Nunc ut vulputate nisi. Donec nec tincidunt ligula, non porta mi. Etiam eu nunc eu nibh mattis ullamcorper nec et felis. Quisque venenatis eros eget neque iaculis, sed euismod dui elementum<br>
																	</div>
																</div>
															</div>
																<ul class="children-comment">
																	<li  class="depth-3">
																		<div class="the-comment">
																			...
																			<div class="comment-box">
																				...
																				<div class="comment-text">
																					<p>Nullam vulputate purus quis maximus imperdiet. Nam sit amet egestas nulla, vitae rhoncus tortor. Duis tortor sapien, vestibulum ac lorem sit amet, posuere elementum justo. Suspendisse iaculis est et neque lobortis condimentum. Quisque rhoncus lectus a rhoncus tincidunt.</p>
																				</div>
																			</div>
																		</div>
																	</li><!-- #comment-## -->
												...
												<li  class="sin-comment  depth-1">
													<div class="the-comment">
														...
														<div class="comment-box">
															<div class="comment-author meta">
																<p class="com-name"><strong>Sajib Talukder</strong></p>
															...
															<div class="comment-text">
																<p>Vivamus in semper lorem, id feugiat mi. Ut eu sem lorem. Aliquam vel libero mauris. Integer pellentesque quis mauris eu scelerisque. Vestibulum sodales, velit ut scelerisque mollis, elit est facilisis purus, sed sodales velit enim et nibh. Curabitur id dui id elit tempus consequat sit amet sit amet sapien.</p>
															</div>
														</div>
													</div>
												</li><!-- #comment-## -->
                        ...
                        <span>
                            <input type="text" placeholder="Wbsite">  
                        </span>
                        ...
                        <a class="button-link" href="#">Post comment</a>
                    </form>
											</div>
