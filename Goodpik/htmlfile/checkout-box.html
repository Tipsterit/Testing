...
<html class="no-js" lang="">
    ...
    <body class="home-1 checkout-page ">
        <!--[if lt IE 8]>
                            ...
                            <div class="your-order">
                                    ...
                                    <table>
                                        ...
                                        <tfoot>
                                            ...
                                            <tr class="shipping">
                                                <th>Shipping</th>
                                                <td>
                                                    <span class="flatrate">Flat rate : </span><span class="amount"> £215.00</span>	
                                                </td>
                                            </tr>
                                ...
                                <div class="payment-method">
                                    <div class="payment-accordion">
                                        ...
                                        <!-- ACCORDION START -->
                                        <h3 class="">Cheque Payment</h3>
                                        <div class="payment-content">
                                            <p>Please send your cheque to Store Name, Store Street, Store Town, Store State / County, Store Postcode.</p>                                    
                                        </div>
                                        <!-- ACCORDION END -->	
                                        <!-- ACCORDION START -->
                                        <h3 >PayPal <img alt="" src="img/payment-pp.png"></h3>
                                        <div class="payment-content">
