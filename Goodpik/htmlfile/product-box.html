                    ...
                    <div class="col-md-12">
                        <div class="bread-crumb">
                            <ul>
                                ...
                                <li class="bc-home"><a href="#">shop</a></li>
                                <li class="bc-home"><a href="#">beauty</a></li>
                                <li>Shop</li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="col-md-9 col-sm-12">
                        <div class="col-sm-5 col-md-5 no-padding">
                            <div class="zoomWrapper">
                                <div id="img-1" class="zoomWrapper single-zoom">
                                    <a href="#" class="">
                                    <img id="zoom1" src="img/z-in4.jpg" data-zoom-image="img/big-4.jpg" alt="big-6">
                                    </a>
                                </div>
                                <div class="single-zoom-thumb">
                                    <ul class="zoom-slider" id="gallery_01">
                                        <li>
                                            ...
                                            data-update="" data-image="img/z-in1.jpg" 
                                            data-zoom-image="img/big-1.jpg">
                                            <img src="img/gal-1.jpg" alt="zo-th-1" />
                                            </a>
                                        </li>
                                        <li class="">
                                             <a href="#" class="elevatezoom-gallery active" 
                                             data-update="" data-image="img/z-in2.jpg" 
                                             data-zoom-image="img/big-2.jpg">
                                             <img src="img/gal-2.jpg" alt="zo-th-1" />
                                            </a>
                                        </li>
                                        <li class="">
                                             <a href="#" class="elevatezoom-gallery active" 
                                             data-update="" data-image="img/z-in3.jpg" 
                                             data-zoom-image="img/big-3.jpg"><img src="img/gal-3.jpg" alt="zo-th-1" />
                                            </a>
                                        </li>
                                        <li class="">
                                          <a href="#" class="elevatezoom-gallery active" 
                                           data-update="" data-image="img/z-in4.jpg" 
                                           data-zoom-image="img/big-4.jpg"><img src="img/gal-4.jpg" alt="zo-th-1" />
                                          </a>
                                        </li>
                                        <li class="">
                                             <a href="#" class="elevatezoom-gallery active" 
                                             data-update="" data-image="img/z-in5.jpg" 
                                             data-zoom-image="img/big-5.jpg"><img src="img/gal-5.jpg" alt="zo-th-1" />
                                            </a>
                                        </li>
                                        <li class="">
                                            <a href="#" class="elevatezoom-gallery active" 
                                            data-update="" data-image="img/z-in1.jpg" 
                                            data-zoom-image="img/big-1.jpg"><img src="img/gal-1.jpg" alt="zo-th-1" />
                                            </a>
                                        </li>
                                    </ul>
                                </div>
                        ...
                        <div class="col-sm-7 col-md-7">
                            <div class="prod-list-detail">
                                <div class="prod-info">
                                    <h2 class="pro-name">Aenean eu tristique</h2>
                                    <div class="price-box">
                                        <div class="price">
                                            <span>$50</span>        
                                        </div>
                                    ...
                                    <div class="cart-plus-minus-button">
                                        <input type="number" value="0" name="qtybutton" class="cart-plus-minus">
                                    </div>
                                    ...
                                    <div class="actions product-wish-compare">
                                        ...
                                        <span>
                                            <a href="#" data-toggle="tooltip" title="compare"><i class="fa fa-bar-chart"></i>
                                            <span>compare</span></a>
                                        </span>
                                    </div>
                                    <span class="prod-meta"><strong>CATEGORY :</strong><a href="#"> Health and Beauty</a></span>
                            ...
                            <div class="bs-area-wrapper">
                                <div class="single-bestseller">
                                    <div class="product-image">
                                        <div class="show-img">
                                           <a href="#"><img alt="" src="img/products/prod-2a.jpg"></a> 
                                        </div>
                                ...
                                <div class="single-bestseller">
                                    <div class="product-image">
                                        <div class="show-img">
                                           <a href="#"><img alt="" src="img/products/prod-6b.jpg"></a> 
                                        </div>
                                        <div class="hide-img">
                                            <a href="#"><img alt="" src="img/products/prod-1b.jpg"></a>    
                                        </div>
                                    </div>
                                    <div class="bs-area-info">
                                            <div class="prod-info">
                                ...
                                <div class="single-bestseller">
                                    <div class="product-image">
                                        <div class="show-img">
                                           <a href="#"><img alt="" src="img/products/prod-8b.jpg"></a> 
                                        </div>
                                        <div class="hide-img">
                                            <a href="#"><img alt="" src="img/products/prod-10b.jpg"></a>    
                                        </div>
                                    </div>
                                    <div class="bs-area-info">
                                        <div class="prod-info">
                                            <h2 class="pro-name">
                                                <a href="#">Zoorew ders</a>
                                            </h2>
                                            <div class="rating">
                                                <i class="fa fa-star"></i>
                                                <i class="fa fa-star"></i>
                                ...
                                <div class="single-bestseller">
                                    <div class="product-image">
                                        <div class="show-img">
                                           <a href="#"><img alt="" src="img/products/prod-12a.jpg"></a> 
                                        </div>
                                        <div class="hide-img">
                                            <a href="#"><img alt="" src="img/products/prod-14b.jpg"></a>    
                                        </div>
                                    </div>
                                    <div class="bs-area-info">
                                        <div class="prod-info">
                                            <h2 class="pro-name">
                                                <a href="#">Mainr herrw</a>
                                            </h2>
                                            <div class="rating">
                                                <i class="fa fa-star"></i>
                                                <i class="fa fa-star"></i>
                    ...
                    <div class="col-md-12">
                        <div class="review-wrapper">
                            <ul class="review-menu">
                                <li class="active"><a data-toggle="tab" href="#pr-description">description</a></li>
                                <li><a data-toggle="tab" href="#pr-reviews">reviews(1)</a></li>
                            </ul>
                                   ...
                                   <div class="product-comment">
                                       ...
                                       <div class="comment-a">
                                            ...
                                            <div class="comment-text">
                                                ...
                                                <p class="meta"><strong>admin</strong> &ndash; March 23, 2015</p>
                                                <div class="pro-com-des">
                                                    <p>Lorem et placerat vestibulum, metus nisi posuere nisl, in accumsan elit odio quis mi.
                                                    in accumsan elit odio quis mi.</p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="add-review">
                                            ...
                                            <p class="comment-form-email"><label>Email <span class="required">*</span></label> 
                                            ...
                                            <textarea aria-required="true" rows="8" cols="45" ></textarea>
                                            </p>
                                            <p class="form-submit"><input value="submit " type="submit" class="submit"></p>
                                        </div>
                                   </div>
